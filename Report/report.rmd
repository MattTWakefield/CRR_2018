...
\par One of the simplest ways of assessing the magnitude of the fire problem in your fire department's area is to draw comparisons with the State of Tennessee as a whole. Below you can see how your fire department compares to the state in three key areas:

* Percentage of population at high risk: The percentage of the population your fire department serves that is considered high risk. High risk factors include income, education, and home values.
...
* Structure Fire Death Frequency: For your fire department, this is the frequency that a fatality has occurred over the past five years. For the state comparison, we used the anticipated frequency of fatalities, assuming your fire department had the same fatality rate that Tennessee has. \par
...
Below, the top causes are listed for your department for 2016. Not all fires are equal and as such, the cause associated with your most frequent fires are not always your most deadly or costly. 
...
##A Snapshot of High Risk in Your Community:
These three demographic risk factors; age, household income and education were all found to be highly related to the chance of a fire incident occurring. Below you will find a table that shows your department's demographics compared to the state as a whole. Those demographic characteristics highlighted in red indicate your protected population is **higher** compared to the state. 
\vspace{10mm}
...
Though only 50% of Tennessee's housing stock was built before 1980, 83% of fire deaths occur in these homes. As fire service professionals, it is important to realize how many of these high risk structures are in your community. 
...
While fire fatalities aren't a measure of fire department quality, they can assist us in preventing similar tragedies from occurring. Below is a brief overview of fire fatalities in `r FD_NAME`'s jurisdiction since 2011.
...
NFPA 1710 states that career fire departments should be responding to structure fires within 4 minutes or less and that turnout time should take no longer than 1 minute and 20 seconds 90% of the time. The metric of 5 minutes and 20 seconds assumes that all incidents had a 1 minute and 20 second turnout time.
...
This metric does not contain any incidents other than structure fires where a valid and complete NFIRS record was submitted. 
...
The large the circle, the more financial loss is associated with that cause within that year. The higher up the circle indicates that there were more fires. 
...
```{r  heatmap, fig.width=10,fig.height=6.0,fig.align="center",echo=FALSE}
fd.at.plot
```
